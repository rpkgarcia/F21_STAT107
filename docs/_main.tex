...
All the objects we have created this far are single element \textbf{vectors}. \texttt{R} is a vectorized language, meaning most of the procedures, functions, and operations have been optimized to work with vectors. It is typically advantageous to utilize this feature. A vector is a collection of values of the same data type. We can use the concatenate function, \texttt{c()}, to create vectors, and to make a vector larger.
