...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#source("https://rpkgarcia.github.io/LearnRBook/data_sets/InsectData.csv")}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-124-2.pdf}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-124-3.pdf}
