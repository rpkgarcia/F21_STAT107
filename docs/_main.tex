...
In this chapter we will learn the basics of the Rstudio interface, and operators that will be used throughout this course.
...
\begin{itemize}
\item
  The pane in the bottom right is the R Command Console is where you type R commands for immediate execution.
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{index_keep =}\StringTok{ }\NormalTok{(mydata}\OperatorTok{$}\NormalTok{group }\OperatorTok{==}\StringTok{"G1"}\NormalTok{)}
\NormalTok{group1 =}\StringTok{ }\NormalTok{mydata[index_keep, ]}
\NormalTok{group1}
\end{Highlighting}
\end{Shaded}
